@extends('layout.main') 
@section('page-title', 'Payment Population') 
@section('page-css')
        ...
        <!-- start card -->
           <div class="col-xl-3 col-md-6 info-panel">
                <div class="card card-shadow">
                    ...
                    <span class="ml-15 font-weight-400">BRI</span>
            ...
            <div class="col-xl-3 col-md-6 info-panel">
                <div class="card card-shadow">
                    ...
                    <span class="ml-15 font-weight-400">GOPAY</span>
                    <div class="content-text text-center mb-0">
            ...
            <div class="col-xl-3 col-md-6 info-panel">
                <div class="card card-shadow">
                    ...
                    <span class="ml-15 font-weight-400">BNI</span>
                    <div class="content-text text-center mb-0">
                        <i class="text-danger icon wb-triangle-up font-size-20">
                    </i>
            ...
            <div class="col-xl-3 col-md-6 info-panel">
                <div class="card card-shadow">
                    ...
                    <span class="ml-15 font-weight-400">DANA</span>
                    <div class="content-text text-center mb-0">
                        <i class="text-danger icon wb-triangle-up font-size-20">
                    </i>
                ...
                <div class="card card-shadow">
                  <div class="card-header card-header-transparent py-20">
                    <div class="btn-group dropdown">
                      <a href="#" class="text-body dropdown-toggle blue-grey-700" data-toggle="dropdown">JENIS PAYMENT</a>
